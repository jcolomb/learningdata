...
datatest2= datatest2[datatest2$genotype %in% c("CS_d42","CS_OK371" ,"PKC_CS" ,"PKC_d42" ,"PKC_OK371" ),]
datatest2= droplevels(datatest2)

levels(datatest2$experimentid)
datatest2= datatest2[!datatest2$experimentid %in% c("16_PKCi_d42G4_chaG80_c380" ),]
datatest2= droplevels(datatest2)
